...
public class FauxMarketService implements MarketService {
    ...
    private BarchartHistoricalService<HistoricalResult> histService;
    ...
    public FauxMarketService(String uname, String pword) {
        BarchartHistoricalService<HistoricalResult> hs = new BarchartHistoricalService<HistoricalResult>(uname, pword);
        this.histService = hs;
    ...
    private Instrument makeInstrument(final String symbol) {
